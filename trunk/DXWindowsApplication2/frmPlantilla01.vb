...
Public Class frmPlantilla01
    ...
    Private Sub frmPlantilla01_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
        gaIndicadoresBotones(Me.Tag) = lIndicador.EstadoUIPageButtonGroup
    End Sub

    Private Sub frmPlantilla01_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub frmPlantilla01_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmPlantilla01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Function ObtenerPlantilla01() As DataTable
        Try
            ' Return New PlantillasBL().ObtenerDatosPlantilla(Indicador.SpPrincipal, giIdMedicionZona, Me.Tag, giSubIndicador)
    ...
    Private Sub frmPlantilla01_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub PCCRCC_EncuestaCambiarEstadoMulti(ByVal piBoton As Integer)
        Dim bRetorna As Boolean = False
        Dim sID As String
        Try
    ...
    'Private Sub frmPlantilla01_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.GotFocus
    '    MsgBox("entre a plantilla 01")
    'End Sub
End Class


<Persistent("vCCRCC_GrillaSecundariaPlantilla01")> _
Public Class GrillaSecundariaPlantilla01
    ...
    <DevExpress.Xpo.DisplayName("TipoCategoria")> Public TipoCategoria As String
    <DevExpress.Xpo.DisplayName("EstadoEncuestaCampo")> Public EstadoEncuestaCampo As String
    <DevExpress.Xpo.DisplayName("CodigoNegocioReemplazo")> Public CodigoNegocioReemplazo As Integer
End Class
