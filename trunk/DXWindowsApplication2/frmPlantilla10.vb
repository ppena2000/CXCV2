...
Public Class frmPlantilla10
    ...
    Sub New()
        ...
        Try
            ...
            classInfo2 = session3.GetClassInfo(GetType(GrillaSecundariaPlantilla10))
    ...
    Private Sub frmPlantilla10_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        PCCRCC_LimpiaPersonalizacion(Me.Tag)
    End Sub

    Private Sub frmPlantilla10_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        FCCRCC_GuardaPlantillas(Me.Tag, Me.DockManager2, Me.GridView1, Me.GridView2)
    End Sub


    Private Sub frmPlantilla10_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmPlantilla10_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmPlantilla10_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LostFocus
...
Public Class GrillaSecundariaPlantilla10
